...
class FileSystemManager:
    ...
    def save_intermediate_result(self, pipeline_name: str, run_id: str, page_num: int, data: Any):
        path = os.path.join(self._get_pipeline_path(pipeline_name, run_id), "intermediate", f"page_{page_num}.json")
        with open(path, "w") as f:
...
class Agent0:
    ...
    def create_pipeline(self, pipeline_name: str, input_file_path: str, filename: str, run_id: str = None):
